...
plot3d(ld4,var1=5,var2=7)
plot3d(ld4,var1="V4")
try(plot3d(ld4,var1=30))
try(plot3d(ld4,var1="VT4"))
plot3d(ld8n,p8cn)
...
plot3d(ld4,p4b,var1=5,var2=7)
plot3d(ld4,p4c,var1="V4")
try(plot3d(ld4,p4a,var1=30))
try(plot3d(ld4,p4b,var1="VT4"))
plot3d(ld8n,p8cn)
